  ...
  view.innerHTML = `
    ...
    <div class="grid two" style="margin-top:14px">
      <div class="card">
        ...
        ${midStageBriefs.length ? midStageBriefs.map((b) => `<div class="status-row"><span>${esc(b.business || 'Untitled mission')}</span><span class="status">${esc(b.planning_step.toUpperCase())}</span></div>`).join('') : '<p class="muted">No briefs in progress.</p>'}
